...
class App extends Component {
    ...
    async loadBlockchainData() {
        ...
        //console.log("ethernet accounts - " + this.state.account)
          // create a constant js variable networkId which 
        //is set to blockchain network id 
        const networkId = await web3.eth.net.getId()
        const networkData = KryptoBird.networks[networkId]
        //this.setState({account:String(networkData)}) 
        //console.log("ethernet accounts - " + networkData)
        if(networkData) {
            // EXERCISE TIME!!!! :)
           ...
           // for (const x of contract) { console.log(x); }
          ...
          // load KryptoBirdz
          //const name_1 = await contract.methods.name().call()
          //const kBird = await contract.methods.kryptoBirdz(0).call()
          //console.log(kBird)
